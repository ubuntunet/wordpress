...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Main Header Background Image",$themename),
				   "id" => $shortname."_bg_image",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the main header background image.",$themename)
			),
			...
			array( "name" => esc_html__("Map Type",$themename),
				   "id" => $shortname."_map_type",
				   "type" => "select",
				   "std" => "Roadmap",
				   "desc" => esc_html__("Here you can choose the map type.",$themename),
				   "options" => array("Roadmap", "Satellite","Hybrid","Terrain")),

			array( "name" => esc_html__("Google Maps Homepage Zoom Level",$themename),
				   "id" => $shortname."_homepage_zoom_level",
				   "std" => "3",
				   "type" => "text",
				   "desc" => esc_html__("Here you can set the homepage zoom level for Google Maps.",$themename),
				   "validation_type" => "number"
			),

			array( "name" => esc_html__("Google Maps Default Zoom Level",$themename),
				   "id" => $shortname."_default_zoom_level",
				   "std" => "5",
				   "type" => "text",
				   "desc" => esc_html__("Here you can set the default zoom level for Google Maps.",$themename),
				   "validation_type" => "number"
			),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => esc_html__("Show Author Avatar on Blog Posts",$themename),
				   "id" => $shortname."_show_avatar_on_posts",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => esc_html__("Enable this option to show the post author avatar on Blog Posts.",$themename)
			),
