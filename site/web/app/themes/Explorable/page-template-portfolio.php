	...
	<div class="container<?php if ( $fullwidth ) echo ' fullwidth'; ?>">
		...
		<div id="content" class="clearfix">
			<div id="left-area">
				...
				<div id="et_pt_portfolio_gallery" class="clearfix responsive<?php echo esc_attr( $et_ptemplate_portfolio_class ); ?>">
					<?php $gallery_query = '';
					$portfolio_count = 1;
					$et_open_row = false;
								...
								<div class="et_pt_portfolio_item">
									...
									<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
										<div class="et_pt_portfolio_image<?php if ( $et_has_video ) echo ' et_video'; ?>">
											...
											<a class="et_portfolio_zoom_icon fancybox<?php if ( $et_has_video ) { echo ' mfp-iframe'; } else { echo ' mfp-image'; } ?>" title="<?php the_title_attribute(); ?>"<?php if ( ! $et_has_video ) echo ' rel="portfolio"'; ?> href="<?php if ( $et_has_video ) echo esc_url( '#' . $et_video_id ); else echo($thumbnail['fullpath']); ?>"><?php esc_html_e('Zoom in','Explorable'); ?></a>
											<a class="et_portfolio_more_icon" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more','Explorable'); ?></a>
